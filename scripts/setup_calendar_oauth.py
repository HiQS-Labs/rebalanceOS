...
The Desktop/Installed-app OAuth client is supplied by the operator and resolved
at runtime by rebalance.ingest.google_oauth_client — nothing is embedded here.
See that module for the resolution order (GOOGLE_OAUTH_CLIENT_FILE → the
secrets dir).
