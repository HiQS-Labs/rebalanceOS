...
**Reuses existing work:** This heavily reuses the Gemini synthesis engine infra shipped in the earlier task [GEMINI-WHATS-NEXT-VAULT.md](../1-INBOX/GEMINI-WHATS-NEXT-VAULT.md); this task targets the current default model `gemini-3.5-flash`.
