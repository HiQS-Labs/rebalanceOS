...
> **Restored from the archived predecessor repo** — last modified there 2026-07-07.
...
- **Related upstream signal, no plan change (2026-07-05):** [GH-116](../4-MISC/GH-116-VELOCITY-SIGNAL.md) proposes
  a cross-day velocity/possible-stall signal, computed from the same `collect_pulse_snapshot()`
  substrate the now-daily [GH-112](../3-COMPLETED/GH-112-OBSIDIAN-DAILY-SYNC.md) (18:00 job) and GH-114 (Git Pulse
...
> [GH-101](../4-MISC/GH-101-SIGNAL-QUALITY-CONTRACT.md) fenced off as *out of v1 by design* (the
...
- **Cross the relevance fence?** If Phase 4's attribution shows a *separable, repeatable* signal
  ...
  [GH-101](../4-MISC/GH-101-SIGNAL-QUALITY-CONTRACT.md) scopes to "Phase 4+"** — a genuine
...
- **Provenance:** [duel thread](https://github.com/Hypercart-Dev-Tools/rebalance-OS/blob/development/relay-system/2026-07-02/xyz-rebalance-integration.md) —
