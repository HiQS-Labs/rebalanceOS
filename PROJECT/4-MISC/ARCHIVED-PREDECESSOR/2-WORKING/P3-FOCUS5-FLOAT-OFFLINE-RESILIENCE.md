...
> **Restored from the archived predecessor repo** — last modified there 2026-06-25.
...
Two follow-on enhancements to the now-feature-complete [Focus 5 Float](P2-MACOS-FOCUS5-FLOAT.md) app, both about the case the app can't currently handle well — **`rebalance serve` is not running**:
