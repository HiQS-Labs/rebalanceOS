...
> **Restored from the archived predecessor repo** — last modified there 2026-07-01.
...
The current app in [PROJECT/2-WORKING/P2-MACOS-FOCUS5-FLOAT.md](P2-MACOS-FOCUS5-FLOAT.md) is feature-complete as a local projection, but it is still a thin client. It polls `http://localhost:8787/focus-5.json`, and all meaningful work still lives in Python inside rebalance-OS.
