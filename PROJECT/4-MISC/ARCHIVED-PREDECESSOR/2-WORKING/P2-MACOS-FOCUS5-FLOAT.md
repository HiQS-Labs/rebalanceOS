...
> **Restored from the archived predecessor repo** — last modified there 2026-07-05.
...
- **JSON endpoint** — reuses the exact ranking + live-probe logic already behind `/focus-5`, keeps the app a dumb projection, honors the canonical boundary (mirror, not migration) consistent with [P2-LOVABLE-APP.md](https://github.com/Hypercart-Dev-Tools/rebalance-OS/blob/development/PROJECT/1-INBOX/P2-LOVABLE-APP.md) and the HiQS "signal quality" framing. **Chosen.**
...
- No cloud sync (that's [P2-LOVABLE-APP.md](https://github.com/Hypercart-Dev-Tools/rebalance-OS/blob/development/PROJECT/1-INBOX/P2-LOVABLE-APP.md)).
