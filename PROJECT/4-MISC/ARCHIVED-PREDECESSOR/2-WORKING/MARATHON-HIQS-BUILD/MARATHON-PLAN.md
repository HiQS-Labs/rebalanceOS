...
> **Restored from the archived predecessor repo** — last modified there 2026-08-03.
...
|---|---|---|---|---|
| [M1-SKELETON.yaml](https://github.com/Hypercart-Dev-Tools/rebalance-OS/blob/development/PROJECT/2-WORKING/MARATHON-HIQS-BUILD/M1-SKELETON.yaml) | HiQS Phase 0 — foundation | 6 | codex → agy | now (preflighted) |
| [M2-VAULT-SEARCH.yaml](https://github.com/Hypercart-Dev-Tools/rebalance-OS/blob/development/PROJECT/2-WORKING/MARATHON-HIQS-BUILD/M2-VAULT-SEARCH.yaml) | HiQS Phase 1 — **code only** | 4 | agy → codex | M1 approved |
| [M3-GITHUB.yaml](https://github.com/Hypercart-Dev-Tools/rebalance-OS/blob/development/PROJECT/2-WORKING/MARATHON-HIQS-BUILD/M3-GITHUB.yaml) | HiQS Phase 2 | 2 | codex → agy | **checkpoint A** |
| [M4-ASK-MCP.yaml](https://github.com/Hypercart-Dev-Tools/rebalance-OS/blob/development/PROJECT/2-WORKING/MARATHON-HIQS-BUILD/M4-ASK-MCP.yaml) | HiQS Phase 3 — **code only** | 4 | agy → codex | M3 approved |
| [M5-SURFACES.yaml](https://github.com/Hypercart-Dev-Tools/rebalance-OS/blob/development/PROJECT/2-WORKING/MARATHON-HIQS-BUILD/M5-SURFACES.yaml) | HiQS Phase 4 — **code only** | 2 | codex → agy | **checkpoint B** |
...
- **Coexistence → M5 p2 (build-time, in scope).** Shared machine-scoped embedding lock, own memory
  ...
  [briefs/m5-p2-ops.md](https://github.com/Hypercart-Dev-Tools/rebalance-OS/blob/development/PROJECT/2-WORKING/MARATHON-HIQS-BUILD/briefs/m5-p2-ops.md) and the Phase 4 QA gate.
