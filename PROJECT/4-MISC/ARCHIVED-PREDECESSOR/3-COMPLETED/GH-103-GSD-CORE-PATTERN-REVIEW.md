...
> **Restored from the archived predecessor repo** — last modified there 2026-07-03.
...
|---|---|---|---|
| **XYZ** | vendored .xyz/ — `skills/`, `relay-automation/`, `src/`, `bin/` | shell + relay shims, skill markdown | Improve the swarm/relay harness & its skill ergonomics |
...
`marathon-invocation.txt`) is referenced by .xyz/test/swarm-preflight.sh
...
planner itself — bin/marathon-yaml (schema validate + topological
...
- **`p1` and `p2` ARE structurally independent** — both list `depends_on: p0` only, not each other.
  ...
  src/marathon-yaml.js), not because of a real ordering constraint.
...
[relay-system/2026-07-03/gsd-phase0-122028/](https://github.com/Hypercart-Dev-Tools/rebalance-OS/blob/development/relay-system/2026-07-03/gsd-phase0-122028)
...
[relay-system/2026-07-03/gsd-phase1-124159/](https://github.com/Hypercart-Dev-Tools/rebalance-OS/blob/development/relay-system/2026-07-03/gsd-phase1-124159/).
...
[relay-system/2026-07-03/gsd-phase2-124548/](https://github.com/Hypercart-Dev-Tools/rebalance-OS/blob/development/relay-system/2026-07-03/gsd-phase2-124548).
...
- **Review targets:** XYZ vendored .xyz/; Rebalance native (`src/rebalance/`,
  `.claude/`, PDDA).
