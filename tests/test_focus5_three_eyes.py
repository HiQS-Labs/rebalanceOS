...
class CardGatingTests(unittest.TestCase):
    ...
    def test_none_and_no_raise_when_scan_errors(self):
        with mock.patch.object(web, "_three_eyes_health_scan", side_effect=RuntimeError("launchctl blew up")):
    ...
    def test_scan_is_cached_within_ttl(self):
        with mock.patch.object(web, "_three_eyes_health_scan", return_value=FAILING_REPORT) as m:
