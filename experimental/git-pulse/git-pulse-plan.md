...
- [ ] Use the GitHub-backed sync folder at `~/Documents/GH Repos/rebalance-git-pulse` as the raw data root

## Data Source And Storage Decision

Chosen sync folder:

- Raw data root: `~/Documents/GH Repos/rebalance-git-pulse`
...
- `~/Documents/GH Repos/rebalance-git-pulse/derived/git-pulse-history.sqlite`
