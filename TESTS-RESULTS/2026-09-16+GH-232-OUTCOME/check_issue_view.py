...
def main():
    ...
    mentions = [r for r in original['prompts']
                if (replay.REPO, 'issue', 568) in replay.qualified_references(r['text'])]
    ...
    print(json.dumps(dict(eligible=288, journeys=9, unassigned=212,
                          issue_568_mentions=3, issue_568_unassigned=2,
                          original_bundle_unchanged=True, original_preview_prefix_unchanged=True,
