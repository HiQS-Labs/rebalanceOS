...
def main():
    ...
    assert pairs == {(535, 508), (540, 536), (557, 556), (577, 561), (581, 568), (640, 623), (641, 609), (641, 626)}
    ...
    print(
        json.dumps(
            dict(
                ...
                saved_events=len(after["events"]),
                closing_relationships=len(links),
                review_cases=after["review_cases"],
                open_direct_shared_controls=True,
