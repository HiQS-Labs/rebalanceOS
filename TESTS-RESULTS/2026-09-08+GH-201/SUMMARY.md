...
- **Verdict Rationale**: Average probe latency 505.1ms exceeds 500ms threshold
...
- **Average Remote Peek Latency**: **505.1ms** (Min: 419.1ms, Max: 741.0ms) vs 500ms ceiling.
...
|---|---|---|---|---|---|---|---|
| `hiqs-labs/rebalanceos` | `https://github.com/hiqs-labs/rebalanceos.git` | `development` | `0bffc4dab7` | `None` | No | 481.6 | `OK` |
| `hiqs-labs/gitcanary-fork` | `https://github.com/hiqs-labs/gitcanary-fork.git` | `development` | `14da205413` | `None` | No | 424.0 | `OK` |
| `hypercart-dev-tools/ask-self` | `https://github.com/hypercart-dev-tools/ask-self.git` | `main` | `461574f545` | `None` | No | 741.0 | `OK` |
| `deusdata/codebase-memory-mcp` | `https://github.com/deusdata/codebase-memory-mcp.git` | `main` | `b5185d10c4` | `None` | No | 481.9 | `OK` |
| `aider-ai/aider` | `https://github.com/aider-ai/aider.git` | `development` | `5dc9490bb3` | `None` | No | 523.3 | `OK` |
| `hypercart-dev-tools/ai-ddtk-fix-iterate-loop` | `https://github.com/hypercart-dev-tools/ai-ddtk-fix-iterate-loop.git` | `main` | `61d608df8d` | `None` | No | 495.4 | `OK` |
| `hiqs-labs/aegis-sleuth-slackbot` | `https://github.com/hiqs-labs/aegis-sleuth-slackbot.git` | `development` | `5d04348b7f` | `None` | No | 474.5 | `OK` |
| `hiqs-labs/agentchorus-skill` | `https://github.com/hiqs-labs/agentchorus-skill.git` | `main` | `2b1353d1bf` | `None` | No | 419.1 | `OK` |

### Subprocess Safety Matrix

| Test Case | Description | Result | Latency / Metric | Notes |
|---|---|---|---|---|
| Case 1 | HTTPS credential-helper / askpass hang prevention | PASS | 489.73ms | Production peek_remote_refs failed cleanly without interactive prompt hang |
| Case 2 | Conflicting SSH command options isolation | PASS | 44.8ms | Production build_hardened_ssh_command handled invalid SSH options cleanly without hang |
| Case 3 | Offline network (exit 128 / unreachable host) | PASS | 64.15ms | Offline network cleanly returns None without uncaught exception |
...
| Case 6 | Subprocess timeout & descendant cleanup | PASS | 504.3ms | run_git killed hung process and child descendant (PID 23266) cleanly |
