...
Running it unmodified triggers nothing extra. Because rebalance is local-first and normally has no
network-facing users but you, §13 rarely comes up in practice.
